package laya.media {
	...
	public class SoundManager {
		 ...
		 */
		//lichuang
		public static function playSound(url:String, loops:int = 1, complete:Handler = null, soundClass:Class = null, startTime:Number = 0, volume:Number = -1):SoundChannel {
			...
			channel.url = url;
			channel.volume = (url == _tMusic) ? musicVolume : (volume == -1 ? soundVolume : volume);//lichuang
