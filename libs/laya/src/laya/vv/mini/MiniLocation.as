package laya.vv.mini
{
	...
	public class MiniLocation 
	{
		...
		{
			VVMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			VVMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			VVMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
