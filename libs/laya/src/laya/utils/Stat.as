package laya.utils {
	...
	public class Stat {
		...
		public static function show(x:Number = 0, y:Number = 0):void {
			...
			if (!Render.isConchWebGL && !Browser.onMiniGame &&! Browser.onLimixiu && !Browser.onKGMiniGame && !Browser.onBDMiniGame&& !Browser.onTTMiniGame && !Browser.onQGMiniGame && !Browser.onVVMiniGame && !Browser.onBLMiniGame && !Browser.onQQMiniGame) _useCanvas = true;
