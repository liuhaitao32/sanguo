package laya.utils {
	...
	public class Browser {
		...
		public static function __init__():void {
			...
			onTTMiniGame = /*[STATIC SAFE]*/ u.indexOf('TTGame') > -1;
			...
			else if (Browser.window.hasOwnProperty("bl") && u.indexOf('MiniGame') >-1)
			{
				onBLMiniGame=true;//BILI环境判断
				onMiniGame=false;
			}
			else if (Browser.window.hasOwnProperty("qq") && u.indexOf('MiniGame') >-1)
			{
				onQQMiniGame=true;//BILI环境判断
				onMiniGame=false;
			}
