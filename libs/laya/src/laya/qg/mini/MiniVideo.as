package laya.qg.mini
{
	...
	public class MiniVideo
	{
		...
		public var videoW:Number;
		public var videoH:Number;
		public function MiniVideo(width:Number = 320, height:Number = 240)
		{
			videoW = width;
			videoH = height;
		}
		...
		public function load(url:String):void
		{
			if(!videoElement)
			{
				videoElement = QGMiniAdapter.window.qg.createVideo({width:videoW,height:videoH,autoplay:true,src:url});
