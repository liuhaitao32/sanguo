package laya.qq.mini 
{
	...
	public class MiniLocation 
	{
		...
		{
			QQMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			QQMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			QQMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
