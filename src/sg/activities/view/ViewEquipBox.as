package sg.activities.view
{
	...
	import ui.activities.equipBox.equipBoxUI;
	 ...
	 * @author
	 */
	public class ViewEquipBox extends equipBoxUI{
		...
		public function ViewEquipBox(){
			...
			back.x=this.aniBack.width/2;
			back.y=this.aniBack.height/2;
			this.aniBack.addChild(back);
			...
			Tools.textLayout(this.text0,this.tTime,this.timeImg);
		}

		override public function onAdded():void{
			this.comTitle.setViewTitle(Tools.getMsgById("502073"),true);
