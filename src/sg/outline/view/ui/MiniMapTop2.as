package sg.outline.view.ui {
	...
	import ui.mapScene.MiniMapTop2UI;
	
	/**
	 * ...
	 * @author light
	 */
	public class MiniMapTop2 extends MiniMapTop2UI {		
		...
		override public function init():void {
			...
			//this.scene_container.scale(0.8, 0.8);
			this.scene_container.addChild(this._outline);
			this.cTitle.setViewTitle(Tools.getMsgById("MiniMapTop_3"));
			...
			this._outline.hitArea = new Rectangle(0, 0, this._outline.tMap.width, this._outline.tMap.height);
            this._outline.size(this._outline.tMap.width, this._outline.tMap.height);
			
			//this._outline.graphics.drawRect(0, 0, this._outline.tMap.width, this._outline.tMap.height, "#FF0000", "#000000", 5);
		...
		override public function closeSelf(onlySelf:Boolean = true):void {
			...
			delete ObjectSingle.sDic[ConfigClass.MINI_MAPTOP2[0]];
			this.destroy(true);
		}
